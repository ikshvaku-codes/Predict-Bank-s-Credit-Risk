...
from predict.entity.artifact_entity import ModelPusherArtifact, ModelEvaluationArtifact 
from predict.entity.config_entity import PushModelConfig
import os, sys
import shutil
...
class ModelPusher:
    ...
    def __init__(self, model_pusher_config: PushModelConfig,
